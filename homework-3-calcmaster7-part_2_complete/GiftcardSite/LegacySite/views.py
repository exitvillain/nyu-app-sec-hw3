...
def register_view(request):
    if request.method == 'GET':
        ...
        # Collect data to ensure good password use. Dan Gray -- Hey I think i should delete the following 4 lines.
    ...
    if request.method == 'GET':
        ...
        if prod_num != 0:
            try:
                ...
                graphs['e_counters'].inc()  # Dan Gray -- ADDED PROMETHEUS COUNTER HERE
    ...
    if request.method == "GET":
        ...
        if prod_num != 0:
            try:
                ...
                graphs['e_counters'].inc()  # Dan Gray -- ALSO ADDED PROMETHEUS COUNTER HERE
                return HttpResponse("ERROR: 404 Not Found.")
        else:
            try:
                prod = Product.objects.get(product_id=1) 
